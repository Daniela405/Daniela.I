...
Public Class arreglos
    ...
    Private Sub cmbComputadoras_Validating(sender As Object, e As CancelEventArgs) Handles cmbComputadoras.Validating
    ...
    Private Sub cmbPrecios_Validating(sender As Object, e As CancelEventArgs) Handles cmbPrecios.Validating
        If DirectCast(sender, TextBox).Text.Length > 0 Then
            Me.ErrorValidacion.SetError(sender, "")
        Else
            Me.ErrorValidacion.SetError(sender, "Es un campo obligatorio")
    ...
    Private Sub cmbCompus_Validating(sender As Object, e As CancelEventArgs) Handles cmbCompus.Validating
        If DirectCast(sender, TextBox).Text.Length > 0 Then
            Me.ErrorValidacion.SetError(sender, "")
        Else
            Me.ErrorValidacion.SetError(sender, "Es un campo obligatorio")
    ...
    Private Sub Button1_MouseHover(sender As Object, e As EventArgs) Handles Button1.MouseHover
        tmensaje.SetToolTip(Button1, "Dar click para regresar al menú principal")
        tmensaje.ToolTipTitle = "Descripcion"
        tmensaje.ToolTipIcon = ToolTipIcon.Info
    End Sub
